...
A modern task management application built with React and Redux, inspired by Trello. This application allows users to create boards, lists, and cards to organize their tasks and projects.

## Features

- Create, edit, and organize tasks using a Kanban-style board
...
```bash
git clone https://github.com/Kartikeychandrashukla/trello-clone.git
cd trello-clone
```
...
- [react-textarea-autosize](https://github.com/andreypopp/react-textarea-autosize) - Auto-resizing text areas
- [lodash.throttle](https://lodash.com/) - Performance optimization
